      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-gray-400 font-mono text-sm space-y-1.5 mb-4 border-t border-gray-800 pt-4">
              <p className="text-[#00f0ff]/60 font-bold text-xs tracking-wider mb-2">COMPANY</p>
            ...
            {/* Contact */}
            <div className="text-gray-400 font-mono text-sm space-y-1.5">
              <p className="text-[#00f0ff]/60 font-bold text-xs tracking-wider mb-2">CONTACT</p>
          ...
          <div>
            ...
            {/* Compliance Badges */}
            <h4 className="font-mono text-xs text-[#00f0ff]/60 tracking-wider mb-3">COMPLIANCE</h4>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <div key={i} className="flex items-center gap-1 bg-[#0f1724]/80 border border-gray-700/50 px-2 py-1 rounded text-xs text-gray-400 font-mono">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-gray-400 font-mono text-sm">
            © 2026 <a href="https://www.lognormal.io" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#00f0ff] transition-colors">Lognormal Analytics Pvt. Ltd.</a> All rights reserved.
          </div>
